		...
		<div class="large-8 medium-8 cell">
			...
			<form data-abide novalidate class="grid-x grid-padding-x">
				<div class="large-12 cell">
					...
					<label>Date Range
						<input type="text" id="first_date" name="first_date" placeholder="From Date" required>
						<input type="text" id="second_date" name="second_date" placeholder="To Date" required>
					</label>

					<label>Single Range
						<input type="text" id="single_date" name="single_date" placeholder="Single Date" required>
					</label>
